...
- **Container re-verification**: in progress (24-instance cluster sample, one representative per cluster). Status backfills into this datasheet; raw counts below are mine-time verified.
